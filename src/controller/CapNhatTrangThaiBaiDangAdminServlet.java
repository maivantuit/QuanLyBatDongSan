...
/**
 * Servlet implementation class CapNhatTrangThaiBaiDangAdminServlet
 */
public class CapNhatTrangThaiBaiDangAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CapNhatTrangThaiBaiDangAdminServlet() {
        super();
