...
<h2>#<%=baiDang.getMaBaiDang()%> - <%=baiDang.getTenLoaiBaiDang()%></h2>
...
<table>
	...
	<tr>
		...
		<tr>
			...
			%>
			<td class="buttonxetduyet"  >
			<a
			href="CapNhatTrangThaiGoBaiDangAdminServlet?maBaiDangURL=<%=baiDang.getMaBaiDang()%>">Gỡ bài đăng này
			</a>
			</td>
			<%
				}
